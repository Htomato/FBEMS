// pages/PM/eqExpertReview/eqExpertReview.js
const app = getApp();
Page({
  ...
  changeStatus: function (e) {
    ...
    wx.showModal({
      ...
      success(res) {
        ...
        if (res.confirm) {
          wx.request({
            url: app.serverUrl + '/eqExpert/changeStatus?id=' + id,
            success(res) {
  ...
  quaImg: function (e) {
    ...
    wx.request({
      ...
      success(res) {
        _this.setData({
          eqexpertQuaimage: res.data.eqexpertQuaimage
        })
  ...
  onLoad: function (options) {
    let _this = this
    wx.request({
      url: app.serverUrl + '/eqExpert/review',
      success(res) {
        console.log(res)
        _this.setData({
          reviewList: res.data
